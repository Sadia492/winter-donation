      ...
      <footer className="footer justify-between items-center md:w-4/5 w-11/12 mx-auto p-10">
        <aside>
          ...
          <p className="flex items-center text-xl gap-2">
            <CiLocationOn></CiLocationOn> 41/2, Keshab Banergee Road, Mirpur,
            Dhaka
          </p>
          <p className="flex items-center text-xl gap-2">
            <MdOutlineEmail></MdOutlineEmail> info@gmail.com
          </p>
          <p className="flex items-center text-xl gap-2">
            <FaPhoneAlt></FaPhoneAlt> 258-362-9369
          </p>
        </aside>
        <nav>
          <h6 className="text-white text-2xl font-bold mb-3">Social</h6>
